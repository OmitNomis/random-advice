...
function SecondPage({ toggleScreen, advice, newAdvice }) {
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center min-h-[100vh] text-[#2D0EC6] text-[16px] sm:text-[22px] z-10">
        <h1 className="font-semibold mb-2 text-[18px] sm:text-[24px]  w-full text-center">
          {advice}
        </h1>
        <h2 className=" mb-2 text-[14px] sm:text-[18px] w-full text-center">
